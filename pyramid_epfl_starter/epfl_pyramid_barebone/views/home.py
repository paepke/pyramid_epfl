...
import wtforms
import time, datetime, pkg_resources
...
class FilterForm(epfl.components.Form):
    ...
    set_image = epfl.fields.Button(on_click = "set_image")
    ...
    def handle_set_image(self):
        fn = pkg_resources.resource_filename("epfl_pyramid_barebone", "static/billiger.de.gif")
        self.tv_8.data = epfl.fields.Upload.FileUploadObject().from_file(self.request, fn)
        self.redraw()
