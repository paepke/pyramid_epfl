...
class ComponentBase(object):
    ...
    def get_compo_init_js(self):
        if not self.new_style_compo:
            return ''
        if self.js_parts:
            raise Exception('CompatibilityError: You have set a non empty js_parts attribute on a new style component. '
                            'Check the inheritance chain of your component or set new_style_compo to False.')
