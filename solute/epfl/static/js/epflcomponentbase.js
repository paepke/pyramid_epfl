...
Object.defineProperty(epfl.ComponentBase.prototype, 'elm', {get: function() {
...
epfl.ComponentBase.prototype.before_response = function(data) {}; // Overwrite me!

epfl.ComponentBase.prototype.before_request = function() {}; // Overwrite me!

epfl.ComponentBase.prototype.destroy = function() {}; // Overwrite me!

/* Predefined handle functions */

epfl.ComponentBase.prototype.handle_local_click = function(event) {}; // Overwrite me!

epfl.ComponentBase.prototype.handle_click = function(event) { // Extend me!
    if (!event.originalEvent) {
        return;
    }
    var cid = this.closest_cid(event.originalEvent.target);
    if (cid == this.cid) {
