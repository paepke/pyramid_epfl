...
def check_for_dropzone(compo, expected=True, drop_zone_add_position_top=None, drop_zone_add_text=None):
    compo_html = etree.fromstring(compo.render())
...
def check_for_image(compo, expected=True, src=None):
    compo_html = etree.fromstring(compo.render())
...
def test_no_options(page):
    ...
    check_for_label(compo, expected=False)
...
def test_dropzone_simple_with_no_file_input(page):
    ...
    check_outer_div(compo, height="250", width="250")
    check_for_file_input(compo, expected=False, name="test_upload")
    check_for_dropzone(compo)
    check_for_label(compo, label_text="test_upload_label", label_for="root_node_input")
...
def test_dropzone_with_options(page):
    ...
    check_outer_div(compo, height="250", width="250")
    check_for_file_input(compo, name="test_upload")
    check_for_dropzone(compo, drop_zone_add_position_top="1337", drop_zone_add_text="drop zone test text")
    check_for_label(compo, label_text="test_upload_label", label_for="root_node_input")
